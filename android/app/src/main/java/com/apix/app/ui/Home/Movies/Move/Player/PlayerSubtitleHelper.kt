...
data class SubtitleData(
    ...
    /** Only keep Arabic and English subtitles in playback dialogs. */
    fun isAllowedPlaybackSubtitle(): Boolean {
        val tag = getIETF_tag()?.lowercase() ?: return false
        return tag == "ar" || tag == "en" || tag.startsWith("ar-") || tag.startsWith("en-")
    }
