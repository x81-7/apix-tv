...
import com.lagradost.cloudstream3.moviecompat.Globals.EMULATOR
import com.lagradost.cloudstream3.moviecompat.Globals.TV
import com.lagradost.cloudstream3.moviecompat.Globals.isLayout
...
class CloudStreamApp : Application(), SingletonImageLoader.Factory {
    ...
    companion object {
        ...
        /** Host-app bridge: APiX owns the actual Application. */
        fun initialize(hostContext: Context) {
            context = hostContext.applicationContext
            com.lagradost.api.setContext(WeakReference(context))
            AppDebug.isDebug = BuildConfig.DEBUG
        }
